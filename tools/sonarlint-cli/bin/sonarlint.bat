...
IF EXIST "%SONARLINT_HOME%\lib\sonarlint-cli-2.1-SNAPSHOT.jar" goto run
...
%JAVA_EXEC% -Djava.awt.headless=true %SONARLINT_OPTS% -cp "%SONARLINT_HOME%\lib\sonarlint-cli-2.1-SNAPSHOT.jar" "-Dsonarlint.home=%SONARLINT_HOME%" "-Dproject.home=%PROJECT_HOME%" -Dorg.freemarker.loggerLibrary=none org.sonarlint.cli.Main %*
